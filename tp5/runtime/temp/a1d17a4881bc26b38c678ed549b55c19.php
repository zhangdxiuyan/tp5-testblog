<?php /*a:4:{s:70:"D:\phpstudy\phpstudy_pro\WWW\tp5\application\index\view\cate\cate.html";i:1607151880;s:74:"D:\phpstudy\phpstudy_pro\WWW\tp5\application\index\view\common\header.html";i:1606882706;s:73:"D:\phpstudy\phpstudy_pro\WWW\tp5\application\index\view\common\right.html";i:1607148694;s:72:"D:\phpstudy\phpstudy_pro\WWW\tp5\application\index\view\common\foot.html";i:1605538950;}*/ ?>
<!DOCTYPE html >
<html>
<head>
<title>练习</title> 
	...
	<div class="left">
				...
				<div class="xnews2">
					...
					<div class="dec">
						...
						<div class="time">发布时间：<?php echo htmlentities(date("Y-m-d H:i",!is_numeric($vo['time'])? strtotime($vo['time']) : $vo['time'])); ?>
						</div>
						<p><?php echo htmlentities($vo['brief']); ?></p>
						<div class="time">
							<?php
							$kws=explode(',',$vo['keywords']);
							foreach($kws as $k=>$v){
								echo "<a href='http://127.0.0.1:8080/tp5/public/index.php/index/search/index?keywords=$v'>$v</a>";
							}
							?>
						</div>
					</div>
